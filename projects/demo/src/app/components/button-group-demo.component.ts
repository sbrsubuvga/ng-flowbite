...
@Component({
  ...
  template: `
    <div>
      ...
      <!-- Main Heading -->
      <h1 class="text-4xl font-bold text-white mb-2">Button Group</h1>
      <p class="text-xl text-gray-400 mb-8">Use the button group component to group multiple buttons together.</p>
      ...
      <div *ngIf="activeTab === 'overview'" class="space-y-6">
        <div class="prose prose-invert max-w-none">
          <p class="text-gray-300 leading-relaxed">
            The button group component is used to group multiple buttons together. It provides a consistent way to display related actions.
          </p>
          
          <h2 class="text-2xl font-bold text-white mt-8 mb-4">Features</h2>
          <ul class="list-disc list-inside text-gray-300 space-y-2 ml-4">
            <li>Groups multiple buttons together</li>
            <li>Consistent spacing and styling</li>
            <li>Supports all button color variants</li>
        ...
        <div class="space-y-12">
          ...
          <section id="default">
            <h2 class="text-2xl font-bold text-white mb-4">Default button group</h2>
            <p class="text-gray-400 mb-4">Use the default button group component to group buttons.</p>
            <app-demo-wrapper
              componentName="Default Button Group"
              githubLink="https://github.com/themesberg/flowbite-angular/blob/main/projects/ng-flowbite/src/lib/components/button-group/button-group.component.ts"
            >
              <ngf-button-group>
                <ngf-button-group-item color="blue">Profile</ngf-button-group-item>
                <ngf-button-group-item color="blue">Settings</ngf-button-group-item>
                <ngf-button-group-item color="blue">Messages</ngf-button-group-item>
              </ngf-button-group>
            </app-demo-wrapper>
      ...
      <div *ngIf="activeTab === 'examples'" class="space-y-12">
        ...
        <section id="default">
          <div class="flex items-center justify-between mb-4">
            <h2 class="text-2xl font-bold text-white">Default button group</h2>
            <button
          ...
          <div *ngIf="showDefaultCode" class="mb-4 bg-gray-900 rounded-lg border border-gray-700 overflow-hidden">
            <div class="flex items-center justify-between px-4 py-2 bg-gray-800 border-b border-gray-700">
              <span class="text-sm font-medium text-gray-300">button-group-default.html</span>
              <button
      ...
      <div *ngIf="activeTab === 'api'" class="space-y-8">
        <!-- NgfButtonGroupComponent -->
        <section>
          <h2 class="text-2xl font-bold text-white mb-4">NgfButtonGroupComponent</h2>
          <p class="text-gray-400 mb-6">Button group container component.</p>
          
          <h3 class="text-xl font-semibold text-white mb-3">Selector</h3>
          <div class="bg-gray-800 rounded-lg p-4 mb-6">
            <code class="text-blue-400">ngf-button-group</code>
          </div>
        </section>

        <!-- NgfButtonGroupItemComponent -->
        <section>
          <h2 class="text-2xl font-bold text-white mb-4">NgfButtonGroupItemComponent</h2>
          <p class="text-gray-400 mb-6">Button group item component.</p>
          
          <h3 class="text-xl font-semibold text-white mb-3">Selector</h3>
          <div class="bg-gray-800 rounded-lg p-4 mb-6">
            <code class="text-blue-400">ngf-button-group-item</code>
          </div>
            ...
            <table class="min-w-full divide-y divide-gray-700">
              ...
              <tbody class="bg-gray-900 divide-y divide-gray-700">
                <tr>
                  ...
                  <td class="px-6 py-4 text-sm text-gray-300">Color variant of the button</td>
                </tr>
                <tr>
