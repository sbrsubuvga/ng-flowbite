...
@Component({
  ...
  template: `
    <div>
      ...
      <h1 class="text-4xl font-bold text-white mb-2">Tailwind CSS Datepicker - Flowbite</h1>
      <p class="text-xl text-gray-400 mb-8">Use the datepicker component to select dates.</p>
...
export class DatepickerDemoComponent {
  ...
  defaultCode = `<ngf-datepicker [formControl]="dateControl" placeholder="Select date"></ngf-datepicker>
