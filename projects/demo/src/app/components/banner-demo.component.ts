  ...
  template: `
    <div>
        ...
        <div class="space-y-12">
          ...
          <section id="default">
            ...
            <div class="mb-4 p-4 bg-gray-800 rounded-lg border border-gray-700">
              <ngf-banner color="blue" [dismissible]="true">
      ...
      <div *ngIf="activeTab === 'examples'" class="space-y-12">
        ...
        <section id="default">
          <div class="flex items-center justify-between mb-4">
            <h2 class="text-2xl font-bold text-white">Default banner</h2>
            <button
      ...
      <div *ngIf="activeTab === 'api'" class="space-y-8">
        <section>
          <h2 class="text-2xl font-bold text-white mb-4">NgfBannerComponent</h2>
          <p class="text-gray-400 mb-6">Banner component for displaying announcements.</p>
          
          <h3 class="text-xl font-semibold text-white mb-3">Selector</h3>
          <div class="bg-gray-800 rounded-lg p-4 mb-6">
            <code class="text-blue-400">ngf-banner</code>
          </div>
            ...
            <table class="min-w-full divide-y divide-gray-700">
              ...
              <tbody class="bg-gray-900 divide-y divide-gray-700">
                <tr>
                  ...
                  <td class="px-6 py-4 text-sm text-gray-300">Emitted when the banner is dismissed</td>
                </tr>
              </tbody>
            </table>
          </div>
...
export class BannerDemoComponent {
  ...
  defaultCode = `<ngf-banner color="blue" [dismissible]="true">
  New features are now available! Check out what's new.
</ngf-banner>`;
