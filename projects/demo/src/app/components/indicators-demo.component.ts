...
@Component({
  ...
  template: `
    <div>
      ...
      <h1 class="text-4xl font-bold text-white mb-2">Tailwind CSS Indicators - Flowbite</h1>
      <p class="text-xl text-gray-400 mb-8">Use the indicator component to show badges or status indicators on elements.</p>
          ...
          <div class="mb-4 p-4 bg-gray-800 rounded-lg border border-gray-700">
            <div class="flex gap-4 items-center">
              <div class="relative">
                ...
                <ngf-indicator position="top-right" color="green" [pulse]="true"></ngf-indicator>
              </div>
              <div class="relative">
                <img src="https://flowbite.com/docs/images/people/profile-picture-5.jpg" alt="Avatar" class="w-12 h-12 rounded-full">
...
export class IndicatorsDemoComponent {
  defaultCode = `<div class="relative">
