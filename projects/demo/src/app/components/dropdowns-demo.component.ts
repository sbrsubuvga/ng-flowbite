...
@Component({
  ...
  template: `
    <div>
      ...
      <!-- Main Heading -->
      <h1 class="text-4xl font-bold text-white mb-2">Dropdown</h1>
      <p class="text-xl text-gray-400 mb-8">Use the dropdown component to show a list of items positioned on top of the page.</p>
      ...
      <div *ngIf="activeTab === 'overview'" class="space-y-6">
        <div class="prose prose-invert max-w-none">
          <p class="text-gray-300 leading-relaxed">
            The dropdown component is used to display a list of items in a menu that appears when clicking a trigger button. It supports multiple placement options and can be closed by clicking outside or pressing ESC.
          </p>
          
          <h2 class="text-2xl font-bold text-white mt-8 mb-4">Features</h2>
          <ul class="list-disc list-inside text-gray-300 space-y-2 ml-4">
            <li>Multiple placement options: top, bottom</li>
            <li>Alignment options: start, end</li>
            <li>Keyboard support (ESC to close)</li>
            <li>Click outside to close</li>
            <li>Custom toggle content support</li>
            <li>Danger item styling</li>
      ...
      <div *ngIf="activeTab === 'examples'" class="space-y-12">
        ...
        <section id="default">
          <div class="flex items-center justify-between mb-4">
            <h2 class="text-2xl font-bold text-white">Default dropdown</h2>
            <button
      ...
      <div *ngIf="activeTab === 'api'" class="space-y-8">
        <!-- NgfDropdownComponent -->
        <section>
          <h2 class="text-2xl font-bold text-white mb-4">NgfDropdownComponent</h2>
          <p class="text-gray-400 mb-6">A component for displaying dropdown menus.</p>
          
          <h3 class="text-xl font-semibold text-white mb-3">Selector</h3>
          <div class="bg-gray-800 rounded-lg p-4 mb-6">
            <code class="text-blue-400">ngf-dropdown</code>
          </div>
            ...
            <table class="min-w-full divide-y divide-gray-700">
              ...
              <tbody class="bg-gray-900 divide-y divide-gray-700">
                <tr>
                  ...
                  <td class="px-6 py-4 text-sm text-gray-300">Label text for the dropdown button</td>
                </tr>
                <tr>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-300"><code class="text-blue-400">buttonClass</code></td>
                  <td class="px-6 py-4 text-sm text-gray-300">string</td>
                  <td class="px-6 py-4 text-sm text-gray-300">'bg-blue-700...'</td>
                  <td class="px-6 py-4 text-sm text-gray-300">CSS classes for the dropdown button</td>
                </tr>
                <tr>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-300"><code class="text-blue-400">placement</code></td>
                  <td class="px-6 py-4 text-sm text-gray-300">'top' | 'bottom'</td>
                  <td class="px-6 py-4 text-sm text-gray-300">'bottom'</td>
                  <td class="px-6 py-4 text-sm text-gray-300">Vertical placement of the dropdown menu</td>
                </tr>
                <tr>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-300"><code class="text-blue-400">alignment</code></td>
                  <td class="px-6 py-4 text-sm text-gray-300">'start' | 'end'</td>
                  <td class="px-6 py-4 text-sm text-gray-300">'start'</td>
                  <td class="px-6 py-4 text-sm text-gray-300">Horizontal alignment of the dropdown menu</td>
                </tr>
                <tr>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-300"><code class="text-blue-400">showArrow</code></td>
                  <td class="px-6 py-4 text-sm text-gray-300">boolean</td>
                  <td class="px-6 py-4 text-sm text-gray-300">true</td>
                  <td class="px-6 py-4 text-sm text-gray-300">Whether to show the arrow icon</td>
                </tr>
                <tr>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-300"><code class="text-blue-400">closeOnClick</code></td>
                  <td class="px-6 py-4 text-sm text-gray-300">boolean</td>
                  <td class="px-6 py-4 text-sm text-gray-300">true</td>
                  <td class="px-6 py-4 text-sm text-gray-300">Whether to close the dropdown when clicking an item</td>
                </tr>
              </tbody>
            </table>
          </div>
            ...
            <table class="min-w-full divide-y divide-gray-700">
              ...
              <tbody class="bg-gray-900 divide-y divide-gray-700">
                <tr>
                  ...
                  <td class="px-6 py-4 text-sm text-gray-300">Emitted when the dropdown is opened</td>
                </tr>
                <tr>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-300"><code class="text-blue-400">closed</code></td>
                  <td class="px-6 py-4 text-sm text-gray-300">EventEmitter&lt;void&gt;</td>
                  <td class="px-6 py-4 text-sm text-gray-300">Emitted when the dropdown is closed</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <p class="text-gray-300 leading-relaxed mb-4">
            Use <code class="text-blue-400">ngfDropdownToggle</code> directive to provide custom toggle content. Otherwise, use the <code class="text-blue-400">label</code> input.
          </p>
        </section>

        <!-- NgfDropdownItemComponent -->
        <section>
          <h2 class="text-2xl font-bold text-white mb-4">NgfDropdownItemComponent</h2>
          <p class="text-gray-400 mb-6">A component for dropdown menu items.</p>
          
          <h3 class="text-xl font-semibold text-white mb-3">Selector</h3>
          <div class="bg-gray-800 rounded-lg p-4 mb-6">
            <code class="text-blue-400">ngf-dropdown-item</code>
          </div>
          ...
          <div class="overflow-x-auto mb-6">
            <table class="min-w-full divide-y divide-gray-700">
              ...
              <tbody class="bg-gray-900 divide-y divide-gray-700">
                <tr>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-300"><code class="text-blue-400">danger</code></td>
                  <td class="px-6 py-4 text-sm text-gray-300">boolean</td>
                  <td class="px-6 py-4 text-sm text-gray-300">false</td>
                  <td class="px-6 py-4 text-sm text-gray-300">Whether to apply danger styling (red text)</td>
                </tr>
              </tbody>
            </table>
          </div>
...
export class DropdownsDemoComponent {
  ...
  defaultCode = `<ngf-dropdown label="Dropdown button">
  <ngf-dropdown-item>Dashboard</ngf-dropdown-item>
  <ngf-dropdown-item>Settings</ngf-dropdown-item>
  <ngf-dropdown-item>Earnings</ngf-dropdown-item>
  <ngf-dropdown-item [danger]="true">Sign out</ngf-dropdown-item>
