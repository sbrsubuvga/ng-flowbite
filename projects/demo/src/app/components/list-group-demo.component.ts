...
@Component({
  ...
  template: `
    <div>
      ...
      <h1 class="text-4xl font-bold text-white mb-2">Tailwind CSS List Group - Flowbite</h1>
      <p class="text-xl text-gray-400 mb-8">Use the list group component to show a list of items in a structured format.</p>
