...
@Component({
  ...
  template: `
    <div>
      ...
      <h1 class="text-4xl font-bold text-white mb-2">Tailwind CSS Sidebar - Flowbite</h1>
      <p class="text-xl text-gray-400 mb-8">Use the sidebar component to show a navigation sidebar on the side of the page.</p>
...
export class SidebarDemoComponent {
  defaultCode = `<ngf-sidebar [overlay]="false" position="left">
  <ul class="space-y-2 font-medium">
