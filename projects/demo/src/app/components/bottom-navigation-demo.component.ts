          ...
          <section id="default">
            ...
            <div class="mb-4 p-4 bg-gray-800 rounded-lg border border-gray-700">
              <ngf-bottom-navigation>
                <ngf-bottom-nav-item [active]="true" label="Home" icon="home"></ngf-bottom-nav-item>
                <ngf-bottom-nav-item label="Settings" icon="settings"></ngf-bottom-nav-item>
                <ngf-bottom-nav-item label="Profile" icon="user"></ngf-bottom-nav-item>
              </ngf-bottom-navigation>
            </div>
